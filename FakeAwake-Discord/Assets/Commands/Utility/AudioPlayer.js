...
var Instance = /** @class */ (function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 4:
                        ...
                        if (i > Instance.queuedisplaysize)
                            return [3 /*break*/, 8];
                    ...
                    case 6:
                        switch (i) {
                            case 0:
                                ...
                                this.controlpanelembed.setFooter({ text: "This track was added by: ".concat(this.tracklist[i].added_by.nickname), iconURL: this.tracklist[i].added_by.avatarURL() });
                                break;
                            case 1:
                                result.push("**Next Up**");
                                result.push(this.tracklist[i].GetEmbedText());
    ...
    Instance.prototype.ReloadButtons = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                this.interactioncollector = this.controlpanel.createMessageComponentCollector({ max: 1 });
                this.interactioncollector.once("collect", this.ControlsHandler.bind(this));
