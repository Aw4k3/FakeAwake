...
var config = {
    auth: {
        keyFilePath: path.resolve(__dirname, "secrets/FakeAwake GoogleAPI Token.json"),
        savedTokensPath: path.resolve(__dirname, "secrets/FakeAwake GoogleAPI Token.json")
    },
    conversation: {
        audio: {
